"""
Django settings for dynamic_clay_trading_backend project.
...
ROOT_URLCONF = 'dynamic_clay_trading_backend.urls'
...
WSGI_APPLICATION = 'dynamic_clay_trading_backend.wsgi.application'
